...
namespace RecipeShare.Data.Migrations
{
    ...
    [Migration("20241129215134_IsResponse")]
    partial class IsResponse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9df4bc0-2970-44c1-bd40-a68fad020c30"),
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = new Guid("c15114b0-fe2c-425f-a763-a1ed36ecf522"),
                            Name = "Moderator",
                            NormalizedName = "MODERATOR"
                        },
                        new
                        {
                            Id = new Guid("e43c8a16-3f28-4b90-add2-10a64985989a"),
                            Name = "Administrator",
            ...
            modelBuilder.Entity("RecipeShare.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<bool>("IsResponse")
                        .HasColumnType("bit")
                        .HasComment("Shows if the comment is a Response");

                    b.Property<Guid?>("ParentCommentId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("If the comment is a response -> shows which is the Id of the parent comment");
            ...
            modelBuilder.Entity("RecipeShare.Data.Models.Comment", b =>
                {
                    b.HasOne("RecipeShare.Data.Models.Comment", "ParentComment")
                        .WithMany("Responses")
